...
const inline auto DUMMY_ARG3 = ket::internal::ClonePtr<ket::Matrix2X2> {nullptr};

/*
    Create a single-qubit gate with no parameters.
*/
auto create_one_target_gate(ket::Gate gate, std::size_t target_index) -> ket::GateInfo
{
...
*/
auto unpack_one_target_gate(const ket::GateInfo& info) -> std::size_t
{
...
*/
auto unpack_one_control_one_target_gate(const ket::GateInfo& info) -> std::tuple<std::size_t, std::size_t>
{
...
*/
auto unpack_double_qubit_gate_indices(const ket::GateInfo& info) -> std::tuple<std::size_t, std::size_t>
{
...
*/
auto unpack_gate_angle(const ket::GateInfo& info) -> double
{
