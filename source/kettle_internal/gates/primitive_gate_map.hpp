...
extern const ket::internal::LinearBijectiveMap<ket::Gate, ket::Gate, 10> UNCONTROLLED_TO_CONTROLLED_GATE;

extern const ket::internal::LinearBijectiveMap<ket::Gate, std::string, 22> PRIMITIVE_GATES_TO_STRING;

extern const ket::internal::LinearBijectiveMap<ket::Gate, GateFuncPtr1T, 5> GATE_TO_FUNCTION_1T;

extern const ket::internal::LinearBijectiveMap<ket::Gate, GateFuncPtr1T1A, 4> GATE_TO_FUNCTION_1T1A;

extern const ket::internal::LinearBijectiveMap<ket::Gate, GateFuncPtr1C1T, 5> GATE_TO_FUNCTION_1C1T;
