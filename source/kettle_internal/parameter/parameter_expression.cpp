...
auto unpack_target_and_angle(const MapVariant& parameter_values_map, const ket::GateInfo& info) -> std::tuple<std::size_t, double>
{
...
auto unpack_control_target_and_angle(const MapVariant& parameter_values_map, const ket::GateInfo& info)
