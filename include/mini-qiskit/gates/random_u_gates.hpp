...
*/
inline auto generate_random_unitary2x2(std::mt19937& prng) -> mqis::Matrix2X2
{
...
/*
    ...
    SOURCE: http://home.lu.lv/~sd20008/papers/essays/Random%20unitary%20[paper].pdf
      - page 5, sampling from U(2)
*/
inline auto generate_random_unitary2x2(int seed) -> mqis::Matrix2X2
{
...
/*
    ...
    SOURCE: http://home.lu.lv/~sd20008/papers/essays/Random%20unitary%20[paper].pdf
      - page 5, sampling from U(2)
*/
inline auto generate_random_unitary2x2() -> mqis::Matrix2X2
{
