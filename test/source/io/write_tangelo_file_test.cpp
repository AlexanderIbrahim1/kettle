...
TEST_CASE("format_one_control_one_target_gate_()")
{
    ...
    const auto gate_info = cre::create_one_control_one_target_gate(testcase.gate, testcase.control, testcase.target);
...
TEST_CASE("format_one_target_one_angle_gate_()")
{
    ...
    const auto gate_info = cre::create_one_target_one_angle_gate(testcase.gate, testcase.target, testcase.angle);
...
TEST_CASE("format_one_control_one_target_one_angle_gate_()")
{
    ...
    const auto gate_info =
        cre::create_one_control_one_target_one_angle_gate(testcase.gate, testcase.control, testcase.target, testcase.angle);
